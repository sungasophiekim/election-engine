...
{{
  "clusters": [
    {{"name": "사건 한줄 요약 (20자 이내)", "count": 관련기사수, "comments": 해당이슈관련기사댓글합계, "side": "우리 유리|상대 유리|중립", "sentiment": 감성점수(-100~+100), "community_expected": "긍정|부정|중립", "tip": "캠프 대응 Tip 2줄 이내", "articles": ["대표 기사 제목1", "대표 기사 제목2"]}},
    ...
  ],
            ...
            for t in c.get("articles", [])[:3]:
                ...
                if not url:
                    for orig_title, orig_url in title_to_url.items():
                        if title[:15] in orig_title or orig_title[:15] in title:
                            url = orig_url
                            break
